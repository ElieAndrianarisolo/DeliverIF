...
/**
 * This class represents the command to add a delivery request to a tour.
 * @author H4114
 */
public class CommandAddDeliveryRequest implements Command {
	...
	/**
	 * Creates a command allowing to add a delivery request to a tour 
	 ...
	 */
	public CommandAddDeliveryRequest(DeliveryRequest deliveryRequest, Tour tour, CityMap cityMap) {
